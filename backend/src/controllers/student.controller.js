...
const verifyEmail = async (Email, Firstname, createdStudent_id) => {
    try {
        ...
        //     html: `<p> Hi ${Firstname}, Please click here to <a href="${BASE_URL}/student/verify?id=${createdStudent_id}">verify</a> your E-mail. </p>`
        // };
        ...
        const mailOptions = {
            ...
            <div style="text-align: center;">
                ...
                <br>
                <a href="${BASE_URL}/student/verify?id=${createdStudent_id}">
