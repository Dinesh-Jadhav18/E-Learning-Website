...
function Landing() {
  ...
  // Get teachers according to subject
  const teachersList = async (sub) => {
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/course/${sub}`, {
        method: "GET",
        credentials: "include",
        headers: {
  ...
  return (
    <>
      ...
      <div className="top">
        ...
        <div className="right">
          <img src={Classroom} width={500} alt="Classroom" />
        </div>
      </div>
      ...
      <div className="features">
        ...
        <div className="fets2">
          {/* Expert Mentor */}
          <div
            className="fet cursor-pointer mb-5"
            onClick={AA}
          >
            <img
